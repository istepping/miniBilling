Page({
  ...
  data: {
    ...
    {
     "txt":"个人统计",
     "img":'/images/statistics_img/home_icon1.png',
      "url":'/pages/statistics/personal/personal',
    },
      {
        "txt": "群体统计",
        "img": '/images/statistics_img/home_icon2.png',
        "url": '/pages/statistics/userStatistics/pie_chart/pie_chart',
      },
      {
        "txt": "行为分析",
        "img": '/images/statistics_img/home_icon3.png',
        "url": '/pages/statistics/analysis/analysis',
         },
      {
        "txt": "排行榜",
        "img": '/images/statistics_img/home_icon4.png',
